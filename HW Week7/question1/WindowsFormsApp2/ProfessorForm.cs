...
namespace WindowsFormsApp2
{
    public partial class ProfessorForm : Form
    {
        ...
        {
            btn_registerProfessor.Enabled = true;
        }
        ...
        private void txtBox_identicalNumber_Validating(object sender, CancelEventArgs e)
        {
        ...
        private void btn_registerProfessor_Click(object sender, EventArgs e)
        {
            ...
            {
                string result = Golestan.RegisterProfessor(txtBox_name.Text, txtBox_identicalNumber.Text, (int)(FieldEnum)comBox_field.SelectedItem);
        ...
        private void btn_showStatusProfessor_Click(object sender, EventArgs e)
        {
            string result = Golestan.ProfessorStatus(txtBox_professorIDStatus.Text);
            MessageBox.Show(result);
            Professor p = Golestan.GetProfessor(txtBox_professorIDStatus.Text);
            if (p != null)
            {
                bsClasses.DataSource = p.RegisteredClasses;
                dataGridView_professorStatus.DataSource = bsClasses;
            }
        }
    }
}
